  ...
  return (
    <footer className="mt-16 border-t border-linie">
      <div className="mx-auto max-w-2xl space-y-2 px-5 py-8 text-sm text-tinte-sanft sm:px-6">
        <a href="https://lanalutz.de/" className="lana-partner">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/brand/lana-lutz/skarabaeus-2026-waldgruen.png" width="48" height="48" alt=""/>
          <span><strong>Lana Lutz</strong>Endlich im Einklang mit dir.</span>
        </a>
        <p>
