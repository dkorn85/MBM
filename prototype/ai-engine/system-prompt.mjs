// Der System-Prompt der AI-Engine — ersetzt (via `claude --system-prompt`) den
// Standard-Prompt vollständig. Kodiert Lanas Ton + die harten Safety-Leitplanken
// aus research/02. Das ist der Kern, an dem später Lana mitfeilt.
